...
class PublicData(_BaseData):
    ...
    def __init__(self, params):
        ...
        self.create_ohe_params(self.one_hot_encode_data(self.data_df))
    ...
    def one_hot_encode_data(self, data):
        ...
        return pd.get_dummies(data, drop_first=False, columns=self.categorical_feature_names).astype(int)
    ...
    def get_inverse_ohe_min_max_normalized_data(self, transformed_data):
        ...
        if isinstance(transformed_data, np.ndarray):
            transformed_data = pd.DataFrame(transformed_data, columns = self.ohe_encoded_feature_names)
