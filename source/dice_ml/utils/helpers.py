...
def get_base_gen_cf_initialization(data_interface, encoded_size, adj_matrix, cont_minx, cont_maxx, margin, validity_reg, epochs,
    ...
    from dice_ml.utils.sample_architecture.vae_model import CF_VAE2
    ...
    # BaseGenCF Model
    cf_vae = CF_VAE2(data_interface, encoded_size, adj_matrix)
    ...
    return dataset, normalise_weights, cf_vae, cf_vae_optimizer
